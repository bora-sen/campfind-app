    ...
    <section className="flex flex-col mx-4 md:mx-0 md:w-full bg-primary-accent-pale bg-opacity-20 sm:h-[26rem] sm:justify-center sm:items-start mb-12 p-4 md:p-12">
      <div className="text-start grid gap-4 sm:w-[30rem]">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          />
          <button className="bg-primary-accent-darker transition-colors hover:bg-primary-accent font-bold text-white text-xl py-4 md:px-4 rounded-md">
            Search
          </button>
        </div>
        <NavLink className="underline" replace to="/add/campground">
